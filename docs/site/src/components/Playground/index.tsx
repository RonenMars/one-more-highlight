  ...
  return (
    <Highlight
      ...
      renderMatch={(seg, { style, Tag }) => (
        <Tag style={style}>
          {seg.text}{seg.states.includes('active') && <sup style={{ color: 'var(--hl-yellow)', WebkitTextStroke: '1px #000', paintOrder: 'stroke fill', filter: 'drop-shadow(0 1px 2px rgba(0, 0, 0, 0.4))' }}>★</sup>}
        </Tag>
      )}
    />
  );
